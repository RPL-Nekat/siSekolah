<div class="timeline-centered">    
	<article class="timeline-entry">				
		<div class="timeline-entry-inner">
			<time class="timeline-time" datetime="2014-01-10T03:45"><span>{{date('H:i:s')}}</span> <span>Today</span></time>
	...
	<article class="timeline-entry">				
		<div class="timeline-entry-inner">
			...
			<div class="timeline-label">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi, veniam!</p>
			</div>
		</div>
	</article>
	<article class="timeline-entry left-aligned">
		<div class="timeline-entry-inner">
			...
			<div class="timeline-label">
				...
				<img src="https://images.pexels.com/photos/1327350/pexels-photo-1327350.jpeg" class="img-fluid rounded full-width">
			</div>
		</div>
	</article>
